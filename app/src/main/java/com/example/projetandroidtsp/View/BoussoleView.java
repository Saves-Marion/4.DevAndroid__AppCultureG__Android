package com.example.projetandroidtsp.View;
...
// Paint pour l'arrière plan de la boussole
        ...
        circlePaint.setColor(r.getColor(R.color.colorBleu)); // Définir la couleur
// Paint pour les 2 aiguilles, Nord et Sud
        northPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        northPaint.setColor(r.getColor(R.color.colorJaune));
        southPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        southPaint.setColor(r.getColor(R.color.colorCyan));
